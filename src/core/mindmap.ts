...
import type { KnbaseConfig, IndexData } from "../types.js";
 ...
 */
export function buildMindmap(config: KnbaseConfig, index: IndexData): string {
...
export function renderMindmapDoc(config: KnbaseConfig, index: IndexData): string {
